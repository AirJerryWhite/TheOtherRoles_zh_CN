...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo janitor = new RoleInfo("搬运工", Janitor.color, "和<color=#FF1919FF>黑手党成员</color>毁尸灭迹", "隐匿尸体", RoleId.Janitor);
        ...
        public static RoleInfo eraser = new RoleInfo("抹除者", Eraser.color, "击杀船员并抹除他们的职业", "抹除敌人的职业", RoleId.Eraser);
        ...
        public static RoleInfo tracker = new RoleInfo("追踪者", Tracker.color, "追捕<color=#FF1919FF>内鬼</color>", "追捕到内鬼", RoleId.Tracker);
        public static RoleInfo snitch = new RoleInfo("告密者", Snitch.color, "完成你的任务以获取<color=#FF1919FF>内鬼</color>的信息", "完成你的任务", RoleId.Snitch);
