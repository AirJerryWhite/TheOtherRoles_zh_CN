...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            camouflagerCooldown = CustomOption.Create(31, Types.Impostor, "隐蔽技能冷却", 30f, 10f, 60f, 2.5f, camouflagerSpawnRate);
            ...
            vampireCooldown = CustomOption.Create(42, Types.Impostor, "吸血鬼咬人延迟", 30f, 10f, 60f, 2.5f, vampireSpawnRate);
            ...
            ninjaInvisibleDuration = CustomOption.Create(385, Types.Impostor, "隐身持续时间", 3f, 0f, 20f, 1f, ninjaSpawnRate);
            ...
            guesserNumberOfShots = CustomOption.Create(312, Types.Neutral, "赌怪的猜测次数", 2f, 1f, 15f, 1f, guesserSpawnRate);
            ...
            guesserKillsThroughShield  = CustomOption.Create(315, Types.Neutral, "赌怪猜测无视医生护盾", true, guesserSpawnRate);
            ...
            jesterCanCallEmergency = CustomOption.Create(61, Types.Neutral, "小丑可以拍会议", true, jesterSpawnRate);
            ...
            engineerNumberOfFixes = CustomOption.Create(91, Types.Crewmate, "秒修次数", 1f, 1f, 3f, 1f, engineerSpawnRate);
            ...
            deputyGetsPromoted = CustomOption.Create(108, Types.Crewmate, "警员在警长死后晋升为警长", new string[] { "Off", "On (Immediately)", "On (After Meeting)" }, deputySpawnRate);
            ...
            medicShowShielded = CustomOption.Create(143, Types.Crewmate, "可见护盾的玩家", new string[] {"所有人", "被保护者和医生", "医生"}, medicSpawnRate);
            medicShowAttemptToShielded = CustomOption.Create(144, Types.Crewmate, "被保护者可见击杀尝试", false, medicSpawnRate);
            medicSetOrShowShieldAfterMeeting = CustomOption.Create(145, Types.Crewmate, "护盾会在下一轮生效", new string[] { "Instantly", "Instantly, Visible\nAfter Meeting", "After Meeting" }, medicSpawnRate);
            ...
            portalmakerSpawnRate = CustomOption.Create(390, Types.Crewmate, cs(Portalmaker.color, "雪儿"), rates, null, true);
            portalmakerCooldown = CustomOption.Create(391, Types.Crewmate, "传送枪技能冷却", 30f, 10f, 60f, 2.5f, portalmakerSpawnRate);
            ...
            portalmakerLogHasTime = CustomOption.Create(394, Types.Crewmate, "日志附带时间", true, portalmakerSpawnRate);
            ...
            securityGuardCamPrice = CustomOption.Create(283, Types.Crewmate, "安装摄像头所需的螺丝数量", 2f, 1f, 15f, 1f, securityGuardSpawnRate);
            ...
            securityGuardCamMaxCharges = CustomOption.Create(286, Types.Crewmate, "移动监控最大能量值", 5f, 1f, 30f, 1f, securityGuardSpawnRate);
            securityGuardCamRechargeTasksNumber = CustomOption.Create(287, Types.Crewmate, "移动监控充能所需完成的任务数", 3f, 1f, 10f, 1f, securityGuardSpawnRate);
            ...
            modifierBloodyQuantity = CustomOption.Create(1001, Types.Modifier, cs(Color.yellow, "该效果的人数"), ratesModifier, modifierBloody);
            ...
            modifierAntiTeleportQuantity = CustomOption.Create(1011, Types.Modifier, cs(Color.yellow, "反对者人数"), ratesModifier, modifierAntiTeleport);
            ...
            modifierBaitReportDelayMin = CustomOption.Create(1032, Types.Modifier, "击杀诱饵后延迟报警的最小值", 0f, 0f, 10f, 1f, modifierBait);
            modifierBaitReportDelayMax = CustomOption.Create(1033, Types.Modifier, "击杀诱饵后延迟报警的最大值", 0f, 0f, 10f, 1f, modifierBait);
            ...
            modifierLoverEnableChat = CustomOption.Create(1043, Types.Modifier, "启用恋人的聊天频道", true, modifierLover);
            ...
            // Other options
            maxNumberOfMeetings = CustomOption.Create(3, Types.General, "紧急会议数", 10, 0, 15, 1, null, true);
            ...
            allowParallelMedBayScans = CustomOption.Create(7, Types.General, "运行同时扫描", false);
