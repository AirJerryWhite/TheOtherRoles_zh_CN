...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            impostorRolesCountMin = CustomOption.Create(304, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小内鬼职业数量"), 15f, 0f, 15f, 1f);
            impostorRolesCountMax = CustomOption.Create(305, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最大内鬼职业数量"), 15f, 0f, 15f, 1f);
            ...
            bountyHunterPunishmentTime = CustomOption.Create(323, Types.Impostor, "击杀非赏金目标的击杀冷却惩罚", 20f, 0f, 60f, 2.5f, bountyHunterSpawnRate);
            ...
            ninjaCooldown = CustomOption.Create(381, Types.Impostor, "忍者标记技能冷却", 30f, 10f, 120f, 5f, ninjaSpawnRate);
            ...
            ninjaTraceColorTime = CustomOption.Create(384, Types.Impostor, "标记持续时间", 2f, 0f, 20f, 0.5f, ninjaSpawnRate);
            ...
            jackalKillCooldown = CustomOption.Create(221, Types.Neutral, "豺狼/跟班击杀冷却时长", 30f, 10f, 60f, 2.5f, jackalSpawnRate);
            jackalCreateSidekickCooldown = CustomOption.Create(222, Types.Neutral, "招募技能冷却", 30f, 10f, 60f, 2.5f, jackalSpawnRate);
            ...
            sidekickPromotesToJackal = CustomOption.Create(225, Types.Neutral, "跟班在豺狼死后晋升为豺狼", false, jackalCanCreateSidekick);
            ...
            lawyerIsProsecutorChance = CustomOption.Create(358, Types.Neutral, "律师是起诉人的概率", rates, lawyerSpawnRate);
            ...
            lawyerTargetCanBeJester = CustomOption.Create(351, Types.Neutral, "律师的客户可以是豺狼", false, lawyerSpawnRate);
            pursuerCooldown = CustomOption.Create(356, Types.Neutral, "追捕者空包弹技能冷却", 30f, 5f, 60f, 2.5f, lawyerSpawnRate);
            pursuerBlanksNumber = CustomOption.Create(357, Types.Neutral, "追捕者空包弹数量", 5f, 1f, 20f, 1f, lawyerSpawnRate);
            ...
            deputyGetsPromoted = CustomOption.Create(108, Types.Crewmate, "警员在警长死后晋升为警长", new string[] { "关", "开(立即)", "开(会议后)" }, deputySpawnRate);
            ...
            medicSetOrShowShieldAfterMeeting = CustomOption.Create(145, Types.Crewmate, "护盾生效", new string[] { "立刻", "立即但不可见\n会议后可见", "会议后生效" }, medicSpawnRate);
            ...
            seerMode = CustomOption.Create(161, Types.Crewmate, "通灵技能呈现方式", new string[]{ "死亡闪光 + 显示灵魂", "死亡闪光", "显示灵魂"}, seerSpawnRate);
            ...
            hackerOnlyColorType = CustomOption.Create(173, Types.Crewmate, "黑客黑入主控台时可以看见颜色类型", false, hackerSpawnRate);
            ...
            thiefSpawnRate = CustomOption.Create(400, Types.Neutral, cs(Thief.color, "盗贼"), rates, null, true);
            thiefCooldown = CustomOption.Create(401, Types.Neutral, "盗贼技能冷却", 30f, 5f, 120f, 5f, thiefSpawnRate);
            thiefCanKillSheriff = CustomOption.Create(402, Types.Neutral, "盗贼可以击杀警长", true, thiefSpawnRate);
            thiefHasImpVision = CustomOption.Create(403, Types.Neutral, "盗贼拥有内鬼视野", true, thiefSpawnRate);
            thiefCanUseVents = CustomOption.Create(404, Types.Neutral, "盗贼可以使用管道", true, thiefSpawnRate);

            trapperSpawnRate = CustomOption.Create(410, Types.Crewmate, cs(Trapper.color, "设陷师"), rates, null, true);
            trapperCooldown = CustomOption.Create(420, Types.Crewmate, "设陷师技能冷却", 30f, 5f, 120f, 5f, trapperSpawnRate);
            trapperMaxCharges = CustomOption.Create(440, Types.Crewmate, "最大陷阱充能数量", 5f, 1f, 15f, 1f, trapperSpawnRate);
            trapperRechargeTasksNumber = CustomOption.Create(450, Types.Crewmate, "充能所需的任务数", 2f, 1f, 15f, 1f, trapperSpawnRate);
            trapperTrapNeededTriggerToReveal = CustomOption.Create(451, Types.Crewmate, "陷阱在触发后才可显示", 3f, 2f, 10f, 1f, trapperSpawnRate);
            trapperAnonymousMap = CustomOption.Create(452, Types.Crewmate, "显示匿名地图", false, trapperSpawnRate);
            trapperInfoType = CustomOption.Create(453, Types.Crewmate, "陷阱触发后的信息类型", new string[] { "职业", "好/邪恶 职业", "名称" }, trapperSpawnRate);
            ...
            modifierBloodyQuantity = CustomOption.Create(1001, Types.Modifier, cs(Color.yellow, "败血病特性的人数"), ratesModifier, modifierBloody);
            ...
            modifierAntiTeleportQuantity = CustomOption.Create(1011, Types.Modifier, cs(Color.yellow, "晕传特性的人数"), ratesModifier, modifierAntiTeleport);
            ...
            modifierBaitQuantity = CustomOption.Create(1031, Types.Modifier, cs(Color.yellow, "诱饵特性人数"), ratesModifier, modifierBait);
            ...
            modifierSunglassesQuantity = CustomOption.Create(1051, Types.Modifier, cs(Color.yellow, "墨镜特性的人数"), ratesModifier, modifierSunglasses);
            ...
            modifierMiniGrowingUpInMeeting = CustomOption.Create(1063, Types.Modifier, "迷你船员会在会议时长大", true, modifierMini);

            modifierVip = CustomOption.Create(1070, Types.Modifier, cs(Color.yellow, "贵宾"), rates, null, true);
            modifierVipQuantity = CustomOption.Create(1071, Types.Modifier, cs(Color.yellow, "贵宾特性人数"), ratesModifier, modifierVip);
            ...
            modifierInvertQuantity = CustomOption.Create(1081, Types.Modifier, cs(Color.yellow, "酒鬼特性人数"), ratesModifier, modifierInvert);
            modifierInvertDuration = CustomOption.Create(1082, Types.Modifier, "醉酒持续回合数", 3f, 1f, 15f, 1f, modifierInvert);

            modifierChameleon = CustomOption.Create(1090, Types.Modifier, cs(Color.yellow, "变色龙"), rates, null, true);
            modifierChameleonQuantity = CustomOption.Create(1091, Types.Modifier, cs(Color.yellow, "变色龙特性人数"), ratesModifier, modifierChameleon);
            modifierChameleonHoldDuration = CustomOption.Create(1092, Types.Modifier, "变色所需的静止时间", 3f, 1f, 10f, 0.5f, modifierChameleon);
            modifierChameleonFadeDuration = CustomOption.Create(1093, Types.Modifier, "变色持续时间", 1f, 0.25f, 10f, 0.25f, modifierChameleon);
            modifierChameleonMinVisibility = CustomOption.Create(1094, Types.Modifier, "最低能见度", new string[] { "0%", "10%", "20%", "30%", "40%", "50%" }, modifierChameleon);
            ...
            guesserGamemodeHaveModifier = CustomOption.Create(2004, Types.Guesser, "赌怪是否可以具有特性", true, null);
            guesserGamemodeNumberOfShots = CustomOption.Create(2005, Types.Guesser, "赌怪可猜测次数", 3f, 1f, 15f, 1f, null);
            guesserGamemodeHasMultipleShotsPerMeeting = CustomOption.Create(2006, Types.Guesser, "赌怪可以在会议上连续猜测", false, null);
            guesserGamemodeKillsThroughShield = CustomOption.Create(2008, Types.Guesser, "猜测无视医生护盾", true, null);
            guesserGamemodeEvilCanKillSpy = CustomOption.Create(2009, Types.Guesser, "邪恶赌怪可以猜测间谍", true, null);
            guesserGamemodeCantGuessSnitchIfTaksDone = CustomOption.Create(2010, Types.Guesser, "赌怪不能猜测已经完成任务的告密者", true, null);
            ...
            hideNSeekCommonTasks = CustomOption.Create(3023, Types.HideNSeekMain, cs(Color.yellow, "常规任务"), 1f, 0f, 4f, 1f);
            ...
            hideNSeekTaskWin = CustomOption.Create(3004, Types.HideNSeekMain, cs(Color.yellow, "是否可以通过完成任务获得胜利"), false);
            ...
            huntedShieldRewindTime = CustomOption.Create(3018, Types.HideNSeekRoles, cs(Color.gray, "猎物护盾回退时间"), 3f, 1f, 10f, 1f);
